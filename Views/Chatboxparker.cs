...
{
    public partial class Chatboxparker : Form
    {
        public Chatboxparker(string uid)
        {
            InitializeComponent();
            label7.Text = uid;
        }
        ...
        {
            ParkerDashBoard c = new ParkerDashBoard(label7.Text);
            this.Visible = false;
            c.Visible = true;

        }

        private void Chatboxparker_Load(object sender, EventArgs e)
        {
